...
build:
	@go build -ldflags "-w -s -X main.VERSION=$(RELEASE_TAG)" -gcflags "all=-N -l" -o $(SERVER_BIN) ./cmd/${APP}
...
debug:
	@dlv debug --headless --listen=:8002 --api-version=2 --accept-multiclient ./cmd/${APP}
