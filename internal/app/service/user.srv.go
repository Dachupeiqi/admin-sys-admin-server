...
func (a *UserSrv) CreateTalentUser(ctx context.Context, item schema.User) (*schema.IDResult, error) {
	...
	for _, urItem := range item.UserRoles {
		a.UserRoleRepo.Create(ctx, *urItem)
	}
