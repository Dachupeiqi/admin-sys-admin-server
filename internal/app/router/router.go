...
import (
	"ginAdminServer/internal/app/api"
	"ginAdminServer/internal/app/middleware"
...
func (a *Router) RegisterAPI(app *gin.Engine) {
	...
	v1 := g.Group("/v1")
	{
		...
		gDict := v1.Group("dict")
		{
			gDictData := gDict.Group("/data")
			{
				gDictData.GET("", a.DictAPI.QueryDictData)
				gDictData.GET(":id", a.DictAPI.GetDictData)
				gDictData.POST("", a.DictAPI.CreateDictData)
				gDictData.PUT(":id", a.DictAPI.UpdateDictData)
				gDictData.DELETE(":id", a.DictAPI.DeleteDictData)
			}
			gDictType := gDict.Group("/type")
			{
				gDictType.GET("", a.DictAPI.QueryDictType)
				gDictType.GET(":id", a.DictAPI.GetDictType)
				gDictType.POST("", a.DictAPI.CreateDictType)
				gDictType.PUT(":id", a.DictAPI.UpdateDictType)
				gDictType.DELETE(":id", a.DictAPI.DeleteDictType)
			}
